...
<div id="outer"> 
  ...
  <div id="menu"> 
    ...
    <ul>
      <li><a href="cloud2_home.jsp" >Cloud server2 Home</a></li>
  ...
  <div id="content"> 
    ...
    <p><img src="images/upload.png" height="50" width="50">&nbsp;&nbsp; <strong><em><font color="#990000" size="+1" face="Verdana, Arial, Helvetica, sans-serif" style="text-decoration:underline">Cloud 
      2 All Files</font></em></strong> <br/>
      <br/>
    </p>
...
%>
            <tr bgcolor="#FFFFCC"> 
              ...
              <td align="center"><a href="cloud2_update.jsp?<%=fid%>"><strong><font color="#6300C6">View</font></strong></a></td>
            </tr>
            <%
	   }
	   }
