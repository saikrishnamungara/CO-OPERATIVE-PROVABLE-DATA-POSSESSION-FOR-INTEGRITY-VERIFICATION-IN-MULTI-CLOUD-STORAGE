...
function valid()
{
var a=document.s.fkey.value;
if(a=="")
{
alert("Enter File Key");
document.s.fkey.focus()
return false;
}
}
</script>
...
String fid=(String)session.getAttribute("fid");
	...
	String uid=null,uname=null,fs=null,fn=null,fkey=null;
...
<div id="outer"> 
  ...
  <div id="content"> 
    ...
    <div id="primarycontainer"> 
      ...
      <div class="box"> 
        <form name="s" action="tpa_decrypt.jsp" method="post" onsubmit="return valid()">
          <table width="799" height="400" align="center" cellpadding="20" cellspacing="20">
            ...
            <tr> 
              <td><img src="images/key.png" height="30" width="45"><em><strong><font color="#333333" size="3" face="Courier New, Courier, mono"> 
                File Key</font></strong></em>&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<em> 
                <strong><font face="Times New Roman, Times, serif" size="+1" color="#FF0000"><%=fkey%></font></strong></em></td>
              <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <strong><font color="#333333" size="+1" face="Times New Roman, Times, serif"><em>Enter 
                Key </em></font></strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <input type="text" name="fkey" class="b"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <input type="submit" name="s" value="Decrypt" class="b1" > </td>
            </tr>
            <tr> 
              <td colspan="2" align="center"><font size="2"><b> 
                <%
                                                       ...
                                                       {
                                                               out.println("<font color='red'><blink>File Key Is Incorrect !</blink></font>");
                                                       }
                                               %>
                </b></font></td>
            </tr>
