...
FileInputStream fis=null;
	...
	BufferedWriter bout = new BufferedWriter(new FileWriter("./tpa_verify/block1.txt"));
    bout.write(data1); 
	
	BufferedWriter bout1 = new BufferedWriter(new FileWriter("./tpa_verify/block2.txt"));
    bout1.write(data2); 
	
	
	
	BufferedWriter bout2 = new BufferedWriter(new FileWriter("./tpa_verify/block3.txt"));
    bout2.write(data3); 
...
String l = "./tpa_verify/block1.txt";
...
String m = "./tpa_verify/block2.txt";
...
String n = "./tpa_verify/block3.txt";
