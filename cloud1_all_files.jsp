...
<div id="outer"> 
  ...
  <div id="menu"> 
    ...
    <ul>
      <li><a href="cloud1_home.jsp" >Cloud server1 Home</a></li>
  ...
  <div id="content"> 
    ...
    <p><img src="images/upload.png" height="50" width="50">&nbsp;&nbsp; <strong><em><font color="#990000" size="+1" face="Verdana, Arial, Helvetica, sans-serif" style="text-decoration:underline">Cloud1 
      All Files</font></em></strong> <br/>
      <br/>
    </p>
...
%>
            <tr bgcolor="#FFFFCC"> 
              ...
              <td align="center"><a href="cloud1_update.jsp?<%=fid%>"><strong><font color="#6300C6">View</font></strong></a></td>
            </tr>
            <%
	   }
	   }
 ...
 %>
  ...
  <div id="footer"> 
  <div id="footer" align="center"> <strong><font color="#990033" face="Geneva, Arial, Helvetica, sans-serif" >copy rights @ 2012</font></strong></div>
