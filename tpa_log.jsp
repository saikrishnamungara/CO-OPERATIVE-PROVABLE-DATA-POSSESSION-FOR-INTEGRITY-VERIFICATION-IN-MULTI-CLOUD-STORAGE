...
function valid()
{
var a=document.s.tid.value;
if(a=="")
{
alert("Enter User ID");
document.s.tid.focus();
return false;
}
...
<div id="outer"> 
  ...
  <div id="menu"> 
    ...
    <ul>
      ...
      <li><a href="#" class="active">Tpa</a></li>
      <li><a href="index.html" >Back</a></li>
      <!--  <li><a href="#">Tpa</a></li>
  ...
  <div id="content"> 
    ...
    <p> <strong><em><font color="#990000" size="+1" face="Verdana, Arial, Helvetica, sans-serif" style="text-decoration:underline">TPA 
    ...
    <div id="primarycontainer"> 
      <div id="primarycontent"> 
        ...
        <div class="box"> 
          <form name="s" action="tpa_log1.jsp" method="get" onsubmit="return valid()">
            <table align="center" cellpadding="20" cellspacing="20" width="500">
              <tr> 
                <td><font face="Courier New" size="+1"><strong><img src="images/login1.png">&nbsp;&nbsp;User 
                  ID</strong></font></td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="tid" class="b"></td>
              </tr>
              <tr> 
    ...
    <div id="secondarycontent"> 
      ...
      <div class="post"><img src="images/tpa.gif"> </div>
